...
public class JsonToUrlEncodedAuthenticationFilter implements Filter {
    ...
    /**
     * gets the token reques params through JSON format
     * @param request
     * @param response
     * @param chain
     * @throws IOException
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
            ServletException {
        if (Objects.equals(request.getContentType(), "application/json") && Objects.equals(((RequestFacade) request).getServletPath(), "/token")) {
